...
class TestTextBox:
    ...
    def test_successful_submit_text_box(self, text_box_page: TextBoxPage):
        ...
        text_box_page.text_box_form.fill(
            full_name=settings.test_user.full_name,
            email=settings.test_user.email,
            current_address=settings.test_user.current_address,
            permanent_address=settings.test_user.permanent_address
        )
